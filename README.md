...
C0+C1 are the shipped increments; covariate-value **bands** + the fifth variance component (C2) and exports that compute LBM *the model's way* (C3) remain.
