...
| --- | --- | --- | --- |
| **LA0 — Disposition + site absorption + binding** | proposed | `local_anesthetics` subsystem + schema; disposition PK + site-specific absorption + protein binding for lidocaine, bupivacaine, ropivacaine; **no thresholds yet**. | The systemic concentration trajectory by site is simulable; the site-rank dominance is curated and surfaced. |
